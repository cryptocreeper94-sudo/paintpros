...
- **AI Agent Tab:** Floating AI assistant with tenant-specific designs. Lume Paint Co gets sharp black bowtie at bottom-right (opens to Rollie with bowtie). NPP and PaintPros get blue-handled Rollie at bottom-right. TradeWorks AI skipped (already has AI). Other tenants get purple shield button on side. Connected to ElevenLabs for voice responses.
