  ...
  return (
    ...
    <header className="fixed top-0 left-0 right-0 z-50 border-b border-white/10" style={{ backgroundColor: '#344e41' }}>
      <div className="flex items-center px-1 md:px-2 py-1">
        ...
        <button 
          className={cn(
            "hover:bg-white/10 rounded-lg transition-all flex-shrink-0 flex items-center -ml-[97px] -mt-[31px]",
        ...
        <button 
          onClick={toggleTheme}
          className="w-12 h-12 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center transition-all flex-shrink-0 -ml-[16px]"
