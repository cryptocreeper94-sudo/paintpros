...
export function WeatherRadarModal({ open, onOpenChange, weather, location, onLocationChange }: WeatherRadarModalProps) {
  ...
  return (
    <div 
      className="fixed inset-0 z-50 bg-gradient-to-br from-[#1a2e1a] to-[#0d1a0d] flex flex-col pt-12"
      ...
      <div className="flex flex-col h-full" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="flex items-center justify-between px-3 py-2 border-b border-white/10 flex-shrink-0 gap-2">
          ...
          <div className="flex items-center gap-1.5">
            ...
            />
            <Button size="icon" variant="ghost" onClick={handleZipSearch} disabled={isSearching} className="h-7 w-7 text-white/70 hover:text-white hover:bg-white/10" data-testid="button-search-zip">
        ...
        {/* Controls */}
        <div className="px-2 py-1.5 bg-black/40 border-t border-white/10 flex items-center justify-between gap-2 flex-shrink-0">
