  ...
  return (
    <PageLayout>
      <main className="min-h-screen">
        ...
        <section className="py-8 md:py-12 px-3 md:px-4 bg-gradient-to-b from-white/55 to-gray-50/55">
          <div className="max-w-6xl mx-auto">
            ...
            >
              <h2 className="text-xl md:text-2xl font-display font-bold text-gray-900 dark:text-white mb-2">
                Team Dashboards & Paint Tools
              </h2>
              <p className="text-sm text-gray-600 dark:text-gray-300">
                Quick access for staff and professionals
              </p>
            </motion.div>
            ...
            <div className="grid grid-cols-3 md:grid-cols-6 gap-2 md:gap-4">
              ...
              <Link href="/owner">
                <motion.div
                  ...
                  className="flex flex-col items-center p-3 md:p-4 rounded-xl bg-gradient-to-br from-purple-500/10 to-pink-500/10 border border-purple-500/20 hover:border-purple-500/40 transition-all cursor-pointer"
                  data-testid="link-owner-dashboard"
                >
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center mb-2 shadow-lg shadow-purple-500/30">
                    <Sparkles className="w-5 h-5 md:w-6 md:h-6 text-white" />
                  </div>
                  <span className="text-xs md:text-sm font-medium text-gray-900 dark:text-white">Owner</span>
                </motion.div>
              </Link>
              ...
              <Link href="/admin">
                <motion.div
                  whileHover={{ scale: 1.05 }}
                  className="flex flex-col items-center p-3 md:p-4 rounded-xl bg-gradient-to-br from-blue-500/10 to-cyan-500/10 border border-blue-500/20 hover:border-blue-500/40 transition-all cursor-pointer"
                  data-testid="link-admin-dashboard"
                >
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-gradient-to-br from-blue-500 to-cyan-500 flex items-center justify-center mb-2 shadow-lg shadow-blue-500/30">
                    <Shield className="w-5 h-5 md:w-6 md:h-6 text-white" />
                  </div>
                  <span className="text-xs md:text-sm font-medium text-gray-900 dark:text-white">Admin</span>
                </motion.div>
              </Link>
              ...
              <Link href="/project-manager">
                <motion.div
                  whileHover={{ scale: 1.05 }}
                  className="flex flex-col items-center p-3 md:p-4 rounded-xl bg-gradient-to-br from-teal-500/10 to-emerald-500/10 border border-teal-500/20 hover:border-teal-500/40 transition-all cursor-pointer"
                  data-testid="link-project-manager-dashboard"
                >
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-gradient-to-br from-teal-500 to-emerald-500 flex items-center justify-center mb-2 shadow-lg shadow-teal-500/30">
                    <MapPin className="w-5 h-5 md:w-6 md:h-6 text-white" />
                  </div>
                  <span className="text-xs md:text-sm font-medium text-gray-900 dark:text-white text-center">Project Mgr</span>
                </motion.div>
              </Link>
              ...
              <Link href="/developer">
                <motion.div
                  whileHover={{ scale: 1.05 }}
                  className="flex flex-col items-center p-3 md:p-4 rounded-xl bg-gradient-to-br from-amber-500/10 to-orange-500/10 border border-amber-500/20 hover:border-amber-500/40 transition-all cursor-pointer"
                  data-testid="link-developer-dashboard"
                >
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-gradient-to-br from-amber-500 to-orange-500 flex items-center justify-center mb-2 shadow-lg shadow-amber-500/30">
                    <Layers className="w-5 h-5 md:w-6 md:h-6 text-white" />
                  </div>
                  <span className="text-xs md:text-sm font-medium text-gray-900 dark:text-white">Developer</span>
                </motion.div>
              </Link>
              ...
              <Link href="/color-library">
                <motion.div
                  whileHover={{ scale: 1.05 }}
                  className="flex flex-col items-center p-3 md:p-4 rounded-xl bg-gradient-to-br from-pink-500/10 to-rose-500/10 border border-pink-500/20 hover:border-pink-500/40 transition-all cursor-pointer"
                  data-testid="link-color-library-quick"
                >
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-gradient-to-br from-pink-500 to-rose-500 flex items-center justify-center mb-2 shadow-lg shadow-pink-500/30">
                    <Palette className="w-5 h-5 md:w-6 md:h-6 text-white" />
                  </div>
                  <span className="text-xs md:text-sm font-medium text-gray-900 dark:text-white">Colors</span>
                </motion.div>
              </Link>
              ...
              <Link href="/team">
                <motion.div
                  whileHover={{ scale: 1.05 }}
                  className="flex flex-col items-center p-3 md:p-4 rounded-xl bg-gradient-to-br from-green-500/10 to-emerald-500/10 border border-green-500/20 hover:border-green-500/40 transition-all cursor-pointer"
                  data-testid="link-team-portal"
                >
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-gradient-to-br from-green-500 to-emerald-500 flex items-center justify-center mb-2 shadow-lg shadow-green-500/30">
                    <BadgeCheck className="w-5 h-5 md:w-6 md:h-6 text-white" />
                  </div>
                  <span className="text-xs md:text-sm font-medium text-gray-900 dark:text-white">Team</span>
                </motion.div>
              </Link>
            </div>
          </div>
