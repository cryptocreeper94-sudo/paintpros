...
import { Crown, DollarSign, TrendingUp, Users, Calendar, FileText, Lock, ArrowRight } from "lucide-react";

const OWNER_PIN = "4444";
            ...
            <div className="relative">
              ...
              <GlassCard className="relative p-10 border-gold-400/20" glow>
                <div className="text-center mb-8">
                  <div className="w-20 h-20 mx-auto mb-6 rounded-2xl bg-gradient-to-br from-gold-400/30 to-accent/20 flex items-center justify-center border border-gold-400/30">
