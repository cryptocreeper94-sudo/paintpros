        ...
        <BentoGrid>
          <BentoItem colSpan={8} rowSpan={2}>
            <GlassCard className="p-8 md:p-12">
              ...
              <div className="space-y-4 text-muted-foreground text-lg leading-relaxed">
                <p>
                  {tenant.name} started with a simple mission: to bring a level of professionalism to the trade that was sorely missing. We believe that inviting someone into your home is an act of trust.
                </p>
                <p>
          ...
          <BentoItem colSpan={4} rowSpan={1}>
            <GlassCard className="p-8 flex flex-col justify-center items-center text-center">
              ...
              <h3 className="text-4xl font-bold font-display mb-1">{tenant.credentials?.yearsInBusiness || "15+"}+</h3>
          ...
          <BentoItem colSpan={4} rowSpan={1}>
            <GlassCard className="p-8 bg-accent/10 border-accent/20">
              <h3 className="text-xl font-bold mb-4 flex items-center gap-2">
                <Heart className="w-5 h-5 text-accent" /> {cityName} Proud
              </h3>
              <p className="text-sm text-muted-foreground">
                Locally owned and operated. We're your neighbors, committed to making {cityName} beautiful.
              </p>
            </GlassCard>
          </BentoItem>
          ...
          <BentoItem colSpan={4} rowSpan={1}>
            <GlassCard className="p-8">
              <h3 className="text-xl font-bold mb-4 flex items-center gap-2">
                <CheckCircle2 className="w-5 h-5 text-accent" /> {warrantyYears}-Year Warranty
              </h3>
              <p className="text-sm text-muted-foreground">
