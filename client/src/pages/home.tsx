              ...
              >
                <GlassCard className="p-2 md:p-8 bg-gradient-to-br from-accent/10 to-transparent border-accent/20 cursor-pointer hover:border-accent/40 transition-colors h-full relative overflow-hidden" glow>
                  ...
                  <div className="flex items-center gap-2 md:gap-4 h-full relative z-10">
                          ...
                          <div key={i} className="relative w-3 h-3 md:w-6 md:h-6">
                            ...
                            {!isEmpty && (
                              <div 
                                ...
                                style={{ width: `${fillPercent * 100}%` }}
                              >
                                <Star className="w-3 h-3 md:w-6 md:h-6 fill-[#dc2626] text-[#dc2626] dark:fill-[#ef4444] dark:text-[#ef4444] drop-shadow-[0_0_4px_rgba(220,38,38,0.8)]" />
                              </div>
                            )}
                          </div>
                        );
                    ...
                    <div>
                      <p className="text-lg md:text-3xl font-bold font-display text-[#dc2626] dark:text-[#ef4444] drop-shadow-[0_0_8px_rgba(220,38,38,0.6)]">{tenant.credentials.googleRating}</p>
