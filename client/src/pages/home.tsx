            ...
            >
              <GlassCard className="p-2 md:p-6 flex flex-col h-full cursor-pointer hover:border-accent/40 transition-all relative overflow-hidden" hoverEffect>
                ...
                <div className="flex items-center gap-2 md:gap-4 relative z-10">
                  ...
                  <div className="min-w-0 flex-1">
                    <h3 className="font-bold text-xs md:text-lg text-black dark:text-white">On-Time</h3>
                    <p className="text-[10px] md:text-sm text-black/80 dark:text-white/80 hidden md:block font-bold">We value your time.</p>
                  </div>
                  <ArrowRight className="w-4 h-4 text-accent" />
                </div>
              </GlassCard>
