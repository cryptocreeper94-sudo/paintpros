    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900">
      ...
      <div className="border-b border-slate-700 bg-slate-900/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            >
              <div className="w-10 h-10 rounded-lg bg-gradient-to-r from-sky-500 to-teal-500 flex items-center justify-center">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-20 text-center">
          <Badge className="mb-6 bg-sky-500/20 text-sky-400 border-sky-500/30 px-4 py-2">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button
              size="lg"
              className="bg-gradient-to-r from-sky-600 to-teal-600 text-lg px-8 py-6"
            ...
            <Card className="bg-slate-800 border-slate-700 max-w-md w-full">
              <CardContent className="p-8">
                <div className="text-center mb-6">
                  <div className="w-16 h-16 bg-gradient-to-r from-sky-500 to-teal-500 rounded-2xl flex items-center justify-center mx-auto mb-4">
                ...
                <div className="space-y-4">
                  ...
                  <Button
                    ...
                    disabled={loading}
                    className="w-full bg-gradient-to-r from-sky-600 to-teal-600"
                  >
                    {loading ? (
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex justify-center">
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-sky-500/30 to-teal-500/30 blur-3xl" />
              <Card className="relative bg-slate-800/80 border-sky-500/30 w-80">
                <CardContent className="p-8 text-center">
                  <div className="w-24 h-24 mx-auto mb-4 rounded-full bg-gradient-to-r from-sky-500 to-teal-500 flex items-center justify-center">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {verificationLevels.map((level, i) => (
            <motion.div
              ...
              transition={{ delay: i * 0.1 }}
            >
              <Card className={`bg-slate-800/50 border-slate-700 h-full relative ${level.popular ? 'ring-2 ring-sky-500' : ''}`}>
                {level.popular && (
                ...
                <CardContent className="p-6">
                  ...
                  <Button
                    className={`w-full ${level.popular ? 'bg-gradient-to-r from-sky-600 to-teal-600' : ''}`}
      ...
      {/* CTA */}
      <div className="border-t border-slate-700 bg-gradient-to-r from-sky-900/30 to-teal-900/30 py-16">
