            ...
            <Card className="p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between p-3 bg-blue-500/10 rounded-lg">
                  ...
                  <span className="text-blue-500 font-semibold">20,000+ in 48 hrs</span>
                </div>
              </div>
            </Card>
          </div>
      ...
      content: (
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <Card className="p-5 border-2 border-blue-500/30 hover-elevate cursor-pointer" onClick={() => window.open('https://nashpaintpros.io/crew-lead', '_blank')}>
              <div className="w-14 h-14 rounded-full bg-blue-500/20 flex items-center justify-center mx-auto mb-4">
                <Wrench className="w-7 h-7 text-blue-500" />
              </div>
              <h3 className="font-bold text-lg text-center mb-3">Crew Lead</h3>
              <ul className="text-sm space-y-1 text-muted-foreground">
                <li className="flex items-center gap-1"><CheckCircle2 className="w-3 h-3 text-blue-500" /> Job details</li>
                <li className="flex items-center gap-1"><CheckCircle2 className="w-3 h-3 text-blue-500" /> Field tools</li>
                <li className="flex items-center gap-1"><CheckCircle2 className="w-3 h-3 text-blue-500" /> Time tracking</li>
                <li className="flex items-center gap-1"><CheckCircle2 className="w-3 h-3 text-blue-500" /> Crew info</li>
              </ul>
            </Card>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            ...
            <a href="https://nashpaintpros.io/app" target="_blank" rel="noopener noreferrer" className="block">
              <Card className="p-4 hover-elevate h-full">
                <Wrench className="w-10 h-10 mx-auto mb-3 text-blue-500" />
