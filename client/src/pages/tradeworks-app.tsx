        ...
        <AnimatePresence mode="wait">
                ...
                {todayStats.map((stat, i) => (
                  <Card key={i} className="bg-gray-900/50 border-gray-800 p-4">
                    <div className="flex items-start justify-between mb-2">
                      ...
                      {stat.trend === "up" && <Badge className="bg-blue-500/20 text-blue-400 text-xs">+</Badge>}
                    </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-4 gap-2">
                  {[
                    ...
                    { icon: <FileText className="w-5 h-5" />, label: "Estimate", color: "from-blue-500 to-blue-600", action: () => setActiveSection("money") },
                    ...
                    <Card key={est.id || i} className="bg-gray-900/50 border-gray-800 p-4">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="text-right">
                          ...
                          <Badge className={
                            est.status === "approved" || est.status === "accepted" ? "bg-blue-500/20 text-blue-400" :
          ...
          {activeSection === "money" && (
            <motion.div 
              ...
              className="p-4 space-y-4"
            >
              <Card className="bg-gradient-to-br from-blue-900/50 to-sky-900/50 border-blue-800/50 p-4">
                ...
                <div className="flex items-center gap-2 mt-2">
                  <Badge className="bg-blue-500/20 text-blue-400">{payments.length} payments</Badge>
                    ...
                    <Card key={payment.id || i} className="bg-gray-900/50 border-gray-800 p-4">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="text-right">
                          ...
                          <Badge className={
                            payment.status === "completed" || payment.status === "paid" ? "bg-blue-500/20 text-blue-400" :
                  ...
                  {crewLeads.length > 0 ? crewLeads.map((crew: any, i: number) => (
                    <Card key={crew.id || i} className="bg-gray-900/50 border-gray-800 p-4">
                      <div className="flex items-center justify-between">
                        ...
                        <Badge className={crew.isActive ? "bg-blue-500/20 text-blue-400" : "bg-gray-800 text-gray-400"}>
          ...
          {activeSection === "crew" && (
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-3 mb-4">
                ...
                <Card className="bg-gray-900/50 border-gray-800 p-3 text-center">
                  <p className="text-2xl font-bold text-blue-400">{crewStats?.activeToday || todaysJobs.length}</p>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          <div className="relative">
                            ...
                            <span className={`absolute bottom-0 right-0 w-3 h-3 rounded-full border-2 border-gray-900 ${crew.isActive ? "bg-blue-500" : "bg-gray-500"}`} />
                          </div>
                          <div>
                            <p className="text-white font-medium">{crew.name || 'Crew Lead'}</p>
                            <p className="text-gray-500 text-sm">{crew.specialty || 'General'}</p>
                  ...
                  {todaysJobs.length > 0 ? todaysJobs.map((job: any, i: number) => (
                    <Card key={job.id || i} className="bg-gray-900/50 border-gray-800 p-4">
                      <div className="flex items-center justify-between">
                        ...
                        <Badge className={job.status === "confirmed" ? "bg-blue-500/20 text-blue-400" : "bg-yellow-500/20 text-yellow-400"}>
                          {job.status || 'Scheduled'}
                        </Badge>
                      </div>
                    </Card>
            ...
            >
              <Tabs defaultValue="calculator" className="w-full">
                ...
                <TabsContent value="more" className="space-y-3">
                  <div className="grid grid-cols-2 gap-3">
                    {[
                      { icon: <Camera className="w-6 h-6" />, label: "Room Measure", desc: "Photo measure", color: "from-blue-500 to-blue-600" },
                      ...
                      >
                        ...
                        {message.action && (
                          <div className="mt-2 pt-2 border-t border-white/10">
                            <Badge className={
                              message.action.status === "success" ? "bg-blue-500/20 text-blue-400" :
