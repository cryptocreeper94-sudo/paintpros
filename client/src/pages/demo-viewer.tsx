...
const tradeVerticals = [
  { id: "paint", name: "Painting", icon: Palette, color: "bg-purple-500/20", textColor: "text-purple-600", path: "/trade-home?tenant=lumepaint", description: "Interior & exterior painting services" },
