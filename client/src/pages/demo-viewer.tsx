...
const tradeVerticals = [
  { id: "paint", name: "Painting", icon: Palette, color: "bg-amber-500/20", textColor: "text-amber-600", path: "/trade-home?tenant=paintprosco", description: "Interior & exterior painting services" },
